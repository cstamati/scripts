...
const WW_WEB_COMPONENTS = "https://unpkg.com/@wewear/web-components@1.0.40/dist/wewear-web-components.umd.js";
...
async function WeWearInit() {
    ...
    const config = {
        ...
        mySizePage: `${WW_APP_BASE_URL}/v1/my-size?theme=${installer.getTheme()}`,
        findOutSizePage: `${WW_APP_BASE_URL}/v1/user-data?theme=${installer.getTheme()}`,
        brandUserId: "",
        domain: origin,
        debugMode: false,
